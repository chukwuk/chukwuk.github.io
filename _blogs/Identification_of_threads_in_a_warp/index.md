...
In the 2D block, the blockDim.x is 16, blockDim.y is 8 and blockDim.z is 1. Warp one has $\(D=\{(threadId.x,threadId.y)\in \mathbb{Z}^{2}\mid 0\le x\le 15,0\le y\le 1\}\)$, Warp two has threadId.x ∈ {32,33,34.....63},
